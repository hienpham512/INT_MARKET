...
if(!isset($_GET['article'])){
    ...
    while ($trouve = $donne->fetch()){
        if($trouve['categorie_idCategorie'] == 2){
            echo "<li class='item_produit'>
                    <article class='mode-boisson'>
                        <div class='image-contient'>
                            <a href='./index.php?action=boisson&article=".base64_encode($trouve['idArticle'])."'><img class='item-image' src='data:image/jpeg;base64,".base64_encode($trouve['imageArticle'])."'></a>
                            <div class='item-detail'>
                                <h3 class='item-heading'>
                                    <a class='link' href='./index.php?action=boisson&article=".base64_encode($trouve['idArticle'])."'>".$trouve['nomArticle']."</a>
                                </h3>
